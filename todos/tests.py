...
class TodoModelTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.todo = Todo.objects.create(title="First title", body="A body of text here")

    def test_model_content(self):
        self.assertEqual(self.todo.title, "First title")
        self.assertEqual(self.todo.body, "A body of text here")
        self.assertEqual(str(self.todo), "First title")
